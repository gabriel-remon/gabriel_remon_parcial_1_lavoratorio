...
*
*   @return int return (1) si no todos los caracteres son letras - (0) si todos son letras
*/
...
*   @param tam int tamaño maximo del string
*
*   @return int return (1) si no todos los caracteres son numeros - (0) si todos son numeros
*/
